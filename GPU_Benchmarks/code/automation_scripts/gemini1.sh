...
#ssh root@$node "python3.7 $start_script --git_repo $local_git_path --result_folder $result_path --CarbonTrackerTool --benchmark_id 1 --repetitions 1 --benchmark_binary_dir $local_git_path/$benchmark_binary_dir/"
#scp -r root@$node:$local_git_path/results/ $frontale_git_path/
#scp root@$node:logs.log $frontale_git_path/results/
